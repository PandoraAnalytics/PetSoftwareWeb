...
{
    public partial class buaddfood : ERPBase
    {
        ...
        {           
            ...
            else
            {
                ...
                NameValueCollection collection = AnimalBA.GetAnimalFoodDetail(id);
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            if (success)
            {
                Response.Redirect("bufoodlist.aspx?id=" + BASecurity.Encrypt(ViewState["animalid"].ToString(), PageBase.HashKey));
            }
            else
            {
