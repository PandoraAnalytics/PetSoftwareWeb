...
{
    public partial class buappointmentlist : ERPBase
    {
        ...
        {
            Response.Redirect("bucreateappointment.aspx?id=" + BASecurity.Encrypt(ViewState["id"].ToString(), PageBase.HashKey));
        }
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            NameValueCollection appointmentcollection = AnimalBA.GetAnimalAppointmentDetaillByDate(dateid, this.ConvertToString(ViewState["userid"]));
