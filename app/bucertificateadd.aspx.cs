...
{
    public partial class bucertificateadd : ERPBase
    {   
        ...
        private void PopulateControls()
        {
            ...
            this.ddlType.DataSource = Certificate.GetCertificateTypesByBuId(collection["breedtype"], this.ConvertToInteger(this.CompanyId));
        ...
        protected void btnAddCertificate_Click(object sender, EventArgs e)
        {
            ...
            if (cId > 0)
            {
                ...
                Response.Redirect("bucertificateslist.aspx?id=" + BASecurity.Encrypt(ViewState["animalid"].ToString(), PageBase.HashKey));
            }
            else
            {
                this.lblError.Text = Resources.Resource.error;
