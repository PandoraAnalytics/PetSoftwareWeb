<%@ Page Title="Manage Checklist Category" Language="C#" MasterPageFile="user.Master" AutoEventWireup="true" CodeBehind="checklistcategory.aspx.cs" Inherits="Breederapp.checklistcategory" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <h5 class="float-start">
        <asp:Label ID="Label5" Text="<%$Resources:Resource, ManageChecklistCategory%>" runat="server" CssClass="error_class"></asp:Label></h5>
        ...
        <div class="col-lg-5 col-md-5 col-sm-6 col-xs-12">
            ...
            <div class="row form_row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <asp:Label ID="Label4" runat="server" Text="" CssClass="form_label"><span><%= Resources.Resource.Name %></span>&nbsp;*</asp:Label>
...
<script>
    ...
    function process(pageIndex) {
        ...
        getdata3("GetChecklist_Category", pageIndex, filter, '', GetSetChecklistCat_Success);
    }

    function GetSetChecklistCat_Success(data) {
        $('.datatable tbody').html('');
        var xmldata = data.d;
    ...
    function deleteRecord(id) {
        deleteData("DeleteChecklistCategory", id);
    ...
    function GetChecklistCategory(id) {
        ...
        $.ajax({
            type: "POST",
            url: "Services/getdata.asmx/GetChecklistCategory",
