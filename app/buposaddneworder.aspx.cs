...
{
    public partial class buposaddneworder : ERPBase
    {
        ...
        {                      
            this.ddlCustomer.DataSource = BUOrderManagement.GetPOSCustomer(this.CompanyId);
            ...
            if (!string.IsNullOrEmpty(this.ConvertToString(ViewState["orderid"]))) // EDIT 
            {
                ...
                if (collection != null)
                {
                    ...
                    //this.lblCustName.Text = collection["cfname"] + " " + collection["clname"];
