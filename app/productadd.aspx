<%@ Page Title="Product Add" Language="C#" MasterPageFile="bu.Master" AutoEventWireup="true" CodeBehind="productadd.aspx.cs" Inherits="Breederapp.productadd" %>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
                <h5 class="page_title">
                    <asp:Label ID="lblHeading" Text="Product Add" CssClass="error_class" runat="server"></asp:Label>
                </h5>
            </div>
        </div>
        <br />
                    ...
                    <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                        <li id="tablnkBasic" class="nav-item" role="presentation" runat="server">
                            <button class="nav-link active" id="basic_details-tab" data-bs-toggle="pill" data-bs-target="#tab_basic_details" type="button" role="tab" aria-controls="tab_basic_details"
                                aria-selected="true">
                                <asp:Label ID="lblBasic" runat="server" Text="<%$Resources:Resource, BasicDetails %>"></asp:Label>
                            </button>
                        </li>
                        <li id="tablnkImages" class="nav-item" role="presentation" runat="server">
                            <button class="nav-link" id="images-tab" type="button" role="tab" aria-selected="false">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        ...
                                        <div class="row form_row">
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                <asp:Label ID="Label3" runat="server" CssClass="form_label"><span>Tag</span>&nbsp;</asp:Label>
                                                <asp:TextBox ID="txtproducttags" runat="server" CssClass="form_input" MaxLength="90"></asp:TextBox>
                                                <span class="rule">
                                                    <asp:Label ID="Label5" Text="[Tags can be separated with commas. For example, you can type tag1,tag2,tag3 to create three independent tags]" runat="server"></asp:Label>
                                                </span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row form_row">
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                <asp:Label ID="Label30" runat="server" CssClass="form_label"><span>Threshold Stock Value</span>&nbsp;*</asp:Label>
                                                ...
                                                <span class="rule">
                                                    <asp:Label ID="Label17" Text="[System will show warning when stock reaches to this value]" runat="server"></asp:Label>
                                                </span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row form_row">
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                ...
                                                <input type="hidden" runat="server" id="hid_product_pic" />
                                            </div>
                                        </div>
                        ...
                        <div class="tab-pane fade" role="tabpanel" id="tab_images" aria-labelledby="images-tab" tabindex="0" runat="server">
                            <div class="form_horizontal images_form">
                                <div class="row">
                                    <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
                                        <h6 class="page_title">
                                            <asp:Label ID="Label4" Text="Images" CssClass="error_class" runat="server"></asp:Label>
                                        </h6>
                                    </div>
                                </div>
