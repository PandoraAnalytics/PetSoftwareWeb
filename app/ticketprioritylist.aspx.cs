...
{
    public partial class ticketprioritylist : PageBase
    {
        ...
        private void ApplyFilter()
        {
            ...
            collection.Add("priorityname", this.txtName.Text.Trim());
            Ticket objTicket = new Ticket();
            this.hidfilter.Value = objTicket.TicketSearch(collection);
        }
