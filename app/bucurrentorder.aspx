<%@ Page Title="Current Orders" Language="C#" MasterPageFile="bu.Master" AutoEventWireup="true" CodeBehind="bucurrentorder.aspx.cs" Inherits="Breederapp.bucurrentorder" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="form_horizontal">
        <h6 class="float-start">
            <asp:Label ID="Label11" Text="Current Orders" runat="server" CssClass="error_class"></asp:Label></h6>
        <div class="float-end">
            <asp:LinkButton ID="lnkAdd" CssClass="add_form_btn btnborder" runat="server" OnClick="lnkAdd_Click">
                <i class="fa-solid fa-user-plus"></i>&nbsp;
                    <asp:Label ID="Label2" Text="Add New Order" runat="server"></asp:Label>
            </asp:LinkButton>
        </div>
