...
{
    public partial class comboedit : ERPBase
    {
        ...
        private void PopulateControls()
        {
            ...
            if (collection != null)
            {
                this.txtComboName.Text = collection["title"].ToString();
                this.txtCost.Text = collection["cost"].ToString();             
                ...
                {
                    this.hid_combo_pic.Value = collection["profileimage"].ToString();
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            collection.Add("updatedby", this.UserId);
            collection.Add("taxid", this.ddlTax.SelectedValue);

            bool success = BUProduct.UpdateCombo(collection, ViewState["id"]);
            if (success)
            {
        ...
        {
            Response.Redirect("comboview.aspx?id=" + this.EncComboId);
        }
    }
}