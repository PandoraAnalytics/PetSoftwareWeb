<%@ Page Title="Sevice Edit" Language="C#" MasterPageFile="bu.Master" AutoEventWireup="true" CodeBehind="serviceedit.aspx.cs" Inherits="Breederapp.serviceedit" %>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
                <h5 class="page_title">
                    <asp:Label ID="lblHeading" Text="Service Edit" CssClass="error_class" runat="server"></asp:Label></h5>
            </div>
        </div>
        <br />
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        ...
                                        <div class="row form_row">
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                <asp:Label ID="Label1" runat="server" CssClass="form_label"><span>Tag</span>&nbsp;*</asp:Label>
                                                <asp:TextBox ID="txtServicetags" runat="server" CssClass="form_input" data-validate="required" MaxLength="80"></asp:TextBox>
                                                <span class="rule">
                                        ...
                                        <div class="row form_row">
                                           <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                ...
                                                <asp:TextBox ID="txtAboutDiscription" runat="server" data-validate="required" TextMode="MultiLine" CssClass="form_input" MaxLength="500" Rows="8"></asp:TextBox>
                                            </div>
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                <asp:Label ID="Label12" Text="<%$Resources:Resource, ProfilePic %>" runat="server" CssClass="form_label"></asp:Label>
                                                <input type="file" name="myfile" id="service_pic" accept="image/*" />
                                                <input type="hidden" runat="server" id="hid_service_pic" />&nbsp;&nbsp;<a href="javascript:void(0);" id="lnkServiceProfilePic" runat="server" target="_blank">View Profile Pic</a>
                                            </div>
                                        </div>                                      

                                        <div class="row form-group">
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                <asp:Button ID="btnSaveService" CssClass="form_button" Text="Save and Next" runat="server" OnClick="btnSaveService_Click" />&nbsp;                                                 
        ...
        $('#service_pic').change(function () {
            ...
            $.ajax({
                ...
                success: function (data) {
                    var hid = '#ContentPlaceHolder1_hid_service_pic';
