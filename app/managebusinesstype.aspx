<%@ Page Title="Manage Business Type" Language="C#" MasterPageFile="main.Master" AutoEventWireup="true" CodeBehind="managebusinesstype.aspx.cs" Inherits="Breederapp.managebusinesstype" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="form_horizontal">
        <h5 class="float-start">
            <asp:Label ID="Label5" Text="<%$Resources:Resource, ManageBusinessType%>" runat="server" CssClass="error_class"></asp:Label></h5>
    ...
    <script>
        ...
        function process(pageIndex) {
            ...
            getdata3("GetBusinessTypes", pageIndex, filter, '', GetBusinessTypes_Success);
        }

        function GetBusinessTypes_Success(data) {
            $('.datatable tbody').html('');
            var xmldata = data.d;
        ...
        function deleteRecord(id) {
            deleteData("DeleteBusinessType", id);
        ...
        function GetBusinessType(id) {
            ...
            $.ajax({
                type: "POST",
                url: "Services/getdata.asmx/GetBusinessType",
