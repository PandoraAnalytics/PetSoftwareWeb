...
{
    public partial class certificatetypeedit : PageBase
    {
        ...
        private void PopulateControls()
        {
            ...
            if (collection == null) Response.Redirect("certificatetypelist.aspx");
            ...
            if (Session["associationbreedertype"] != null)
            {
                ...
                if (!string.IsNullOrEmpty(associationbreedertype) && !string.IsNullOrEmpty(collection["breedtype"]))
                {
                    ...
                    if (intersect == null || intersect.Length == 0) Response.Redirect("certificatetypelist.aspx");
                }
