<%@ Page Title="Certificates List" Language="C#" MasterPageFile="bubreeder.master" AutoEventWireup="true" CodeBehind="bucertificateslist.aspx.cs" Inherits="Breederapp.bucertificateslist" %>
                ...
                <div class="table-responsive dt_container">
                    ...
                    <div class="filter_section">
                        <i class="fa-solid fa-filter"></i>&nbsp;
                         ...
                         <asp:TextBox ID="txtName" runat="server" CssClass="form_input" MaxLength="100"></asp:TextBox>&nbsp;
                         <asp:LinkButton ID="btnApply1" CssClass="search_link" runat="server" OnClick="btnApply_Click">
        ...
        function getDetails_Success(data) {
            ...
            if (xmldata != null && xmldata.length > 2) {
                ...
                records.each(function () {
                    ...
                    contents += '<td><a href="docs/' + f + '" target="_blank" class="file">' + f.substring(f.indexOf("_") + 1) + '</a></td>';
