<%@ Page Title="Manage Animal Category" Language="C#" MasterPageFile="main.Master" AutoEventWireup="true" CodeBehind="managebreeds.aspx.cs" Inherits="Breederapp.managebreeds" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="form_horizontal">
        <h5 class="float-start">
            <asp:Label ID="Label5" Text="<%$Resources:Resource, ManageAnimalCategory%>" runat="server" CssClass="error_class"></asp:Label></h5>
        ...
        <div class="row">
            <div class="col-lg-5 col-md-5 col-sm-6 col-xs-12">
                ...
                <div class="row form_row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <asp:Label ID="Label1" runat="server" Text="<%$Resources:Resource, UploadPicture %>" CssClass="form_label"></asp:Label>
            ...
            <div class="col-lg-7 col-md-7 col-sm-6 col-xs-12">
                ...
                <table class="table datatable">
                    <thead>
                        ...
                        <th width="20%">
                            <asp:Label ID="Label2" Text="<%$Resources:Resource, FileName %>" runat="server"></asp:Label></th>
                        <th width="10%">&nbsp;</th>
                    </thead>
    ...
    <script>
        ...
        function process(pageIndex) {
            ...
            getdata3("GetBreedCategories", pageIndex, filter, '', GetSetBreedDoc_Success);
        }
        ...
        function GetSetBreedDoc_Success(data) {
            ...
            if (xmldata != null && xmldata.length > 2) {
                ...
                records.each(function () {
                    ...
                    contents += '<td>' + record.find("breedimage").text() + '</td>';
        ...
        function deleteRecord(id) {
            deleteData("DeleteAnimalTypeCategory", id);
        ...
        function GetBreedDocs(id) {
            ...
            $.ajax({
                type: "POST",
                url: "Services/getdata.asmx/GetBreedCategory",
                ...
                success: function (msg) {
                    if (msg != null && msg.d != null) {
                        ...
                        $("#ContentPlaceHolder1_txtName").val(ppe.breedname);
                        $("#ContentPlaceHolder1_hid_profile_pic").val(ppe.breedimage);
