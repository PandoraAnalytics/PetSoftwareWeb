<%@ Page Title="Welcome to Breeder" Language="C#" MasterPageFile="main.Master" AutoEventWireup="true" CodeBehind="landing.aspx.cs" Inherits="Breederapp.landing" %>
    ...
    <div class="form_horizontal">
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <h6 class="float-start">
                    <asp:Label ID="Label1" Text="<%$Resources:Resource, MyAnimals %>" runat="server" CssClass="error_class"></asp:Label></h6>
                <div class="float-end">
...
<li><a href='gallery.aspx?id={id}'>" + m_gallery + "</a></li>\
<li><a href='appointmentlist.aspx?id={id}'>" + m_appointment + "</a></li>\
<li><a href='createappointment.aspx?id={id}'>" + m_createappointment + "</a></li>\
<li><a href='certificateslist.aspx?id={id}'>" + m_certificatelist + "</a></li>\
<li><a href='noteslist.aspx?id={id}'>" + m_notelist + "</a></li>\
<li><a href='foodlist.aspx?id={id}'>" + m_foodlist + "</a></li>\
<li><a href='useranimallog.aspx?id={id}'>" + m_activitylog + "</a></li>\
</ul>";
                ...
                records.each(function () {
                    ...
                    var contents = '<tr>';
                    if (record.find("profilepic_file").text().length > 0) contents += '<td width="10%"><div class="equipment_img_parent"><a href="basicdetails.aspx?id=' + record.find("id").text() + '" ><img src="../images/image_loading.gif" class="lazy-img equipment_img" data-src="' + record.find(" profilepic_file").text() + '" class="equipment_img alt="x"></a></div ></td>';  // <img src="docs / ' + record.find("profilepic_file").text() + '" alt="p" class="profilepic" />
                    else contents += '<td width="10%"><img src="images/' + record.find("breedimage").text() + '" alt="p" class="profilepic"/></td>';

                    contents += '<td width="35%" style="font-weight: 900; font-size: 15px;"> <a href="basicdetails.aspx?id=' + record.find("id").text() + '" class="btn btn_edit"> ' + record.find("name").text() + '</a></td>';
