<%@ Page Title="Order Details Report" Language="C#" MasterPageFile="bu.Master" AutoEventWireup="true" CodeBehind="staffreportorderdetails.aspx.cs" Inherits="Breederapp.staffreportorderdetails" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="form_horizontal">
        <h5>
            <asp:Label ID="Label11" Text="Order Details Report" runat="server" CssClass="error_class"></asp:Label></h5>
    ...
    <script>        
        ...
        function loadOrderReport() {
            var totalcount = gettotalcount("GetStaffReportsCount", filter);
            process(1);
        ...
        function process(pageIndex) {
            ...
            getdata3("GetStaffReportsList", pageIndex, filter, '', getStaffReportsList_Success);
        }

        function getStaffReportsList_Success(data) {
            $('#ordertable tbody').html('');
            var xmldata = data.d;
            if (xmldata != null && xmldata.length > 2) {
                ...
                records.each(function () {
                    ...
                    contents += "<td><div class='btn-group btn-group-sm dt_action_btns'><a href='buvieworder.aspx?id=" + id + "' class='btn btn_edit' data-toggle='tooltip' data-placement='top' data-original-title='View Details' title='View Details'>View Details</a></div></td>";
                    contents += '</tr>';
