<%@ Page Title="POS Current Orders" Language="C#" MasterPageFile="bu.Master" AutoEventWireup="true" CodeBehind="buposcurrentorder.aspx.cs" Inherits="Breederapp.buposcurrentorder" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="form_horizontal">
        <h6 class="float-start">
            <asp:Label ID="Label11" Text="POS Current Orders" runat="server" CssClass="error_class"></asp:Label></h6>
        <div class="float-end">
            <asp:LinkButton ID="lnkAdd" CssClass="add_form_btn btnborder" runat="server" OnClick="lnkAdd_Click">
                <i class="fa-solid fa-user-plus"></i>&nbsp;
                    <asp:Label ID="Label2" Text="Add POS Order" runat="server"></asp:Label>
            </asp:LinkButton>
        </div>
