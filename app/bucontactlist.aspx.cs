...
{
    public partial class bucontactlist : ERPBase
    {
        ...
        {
            Response.Redirect("bucreatecontact.aspx");
        }
        ...
        protected void btnExportToExcel_Click(object sender, EventArgs e)
        {
            ...
            string filename = "bucontactslist" + BusinessBase.Now.ToString("dd_MM_yyyy_HH_mm") + ".xls";
            try
            {
