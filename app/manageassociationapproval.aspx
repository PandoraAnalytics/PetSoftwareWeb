<%@ Page Title="Association Approval List" Language="C#" MasterPageFile="main.Master" AutoEventWireup="true" CodeBehind="manageassociationapproval.aspx.cs" Inherits="Breederapp.manageassociationapproval" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="form_horizontal">
        <h6 class="float-start">
            <asp:Label ID="Label11" Text="<%$Resources:Resource, AssociationApprovalList %>" runat="server" CssClass="error_class"></asp:Label></h6>
        <div class="float-end">
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <asp:Label ID="lblMessage" runat="server" Style="padding-left: 10px;" CssClass="error_class"></asp:Label>
                ...
                <div class="table-responsive dt_container">
                    <table class="table datatable">
                        <thead>
                            ...
                            <th width="15%">
                                <asp:Label ID="lbladdress" Text="<%$Resources:Resource, ContactNumber %>" runat="server"></asp:Label></th>
                            <th width="15%">
                                <asp:Label ID="Label3" Text="<%$Resources:Resource, EmailAddress %>" runat="server"></asp:Label></th>
                            <th width="15%">
                                <asp:Label ID="Label1" Text="<%$Resources:Resource, Address %>" runat="server"></asp:Label></th>
                            <th width="15%">
                                <asp:Label ID="Label12" Text="<%$Resources:Resource, UserName %>" runat="server"></asp:Label></th>
                            <th width="10%">&nbsp;</th>
                        </thead>
                        <tbody>
                        </tbody>
        ...
        <div class="modal-dialog">
            <div class="modal-content" style="margin-top: 30%;">
                <div class="modal-body">
                    <h6>
                        <asp:Label ID="Label5" Text="<%$Resources:Resource, RejectAssociation %>" CssClass="error_class" runat="server"></asp:Label></h6>
                    <div class="login_form">
                        <div class="row form_row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <asp:Label ID="Label8" Text="<%$Resources:Resource, Reason %>" runat="server" CssClass="form_label"></asp:Label>
    ...
    <div id="modal_approve" class="modal fade">
        <div class="modal-dialog">
            <div class="modal-content" style="margin-top: 30%;">
                <div class="modal-body">
                    <h6>
                        <asp:Label ID="Label4" Text="<%$Resources:Resource, ApproveAssociation %>" CssClass="error_class" runat="server"></asp:Label></h6>
                    <div class="login_form">
                        <div class="row form_row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <br />
                                <asp:Label ID="Label7" Text="<%$Resources:Resource, Approveassociationmessage %>" runat="server" CssClass="form_label"></asp:Label>
                            </div>
                        </div>
                        ...
                        <div class="row form_row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <asp:Button ID="Button1" runat="server" Text="<%$Resources:Resource, Approve %>" CssClass="form_button" OnClick="btnApproval_Click" />&nbsp;
                                    <a href="javascript:void(0);" data-bs-dismiss="modal" aria-label="Close" style="display: inline-block;">
                                        <asp:Label ID="Label10" Text="<%$Resources:Resource, Close %>" runat="server" CssClass="form_label"></asp:Label>
                                    </a>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        ...
        var a_Approve = '<%=  Resources.Resource.Approve %>';
        var a_Reject = '<%=  Resources.Resource.Reject %>';
        $(document).ready(function () {
            filter = $('#ContentPlaceHolder1_hdfilter').val();
            var totalcount = gettotalcount("GetAllAssociationToApproveCount", filter);
            process(1);
            $('.pagination').bootpag({
                total: totalcount,
                page: 1,
        ...
        function process(pageIndex) {
            ...
            getdata3("GetAllAssociationToApprove", pageIndex, filter, '', GetAllAssociations);
        }
        ...
        function GetAllAssociations(data) {
            ...
            if (xmldata != null && xmldata.length > 2) {
                ...
                records.each(function () {
                    ...
                    var contents = '<tr>';
                    contents += '<td><input id="c' + id1 + '" class="call-checkbox" type="checkbox" value="' + id1 + '" /></td>';
                    contents += '<td>' + record.find("name").text() + '</td>';
                    contents += '<td>' + record.find("phone").text() + '</td>';
                    contents += '<td>' + record.find("email").text() + '</td>';
                    contents += '<td>' + record.find("address").text() + '</td>';
                    contents += '<td>' + record.find("fname").text() + ' ' + record.find("lname").text() + '</td>';
                    contents += "<td><div class='btn-group btn-group-sm dt_action_btns'><a href='javascript:void(0);' onclick='singleApprove(" + id1 + ");' class='btn btn_edit' data-toggle='tooltip' data-placement='top' data-original-title=" + a_Approve + " title=" + a_Approve + "><i class='fa-regular fa-thumbs-up'></i></a><a href='javascript:void(0);' onclick='singleReject(" + id1 + ");' class='btn btn_delete' data-toggle='tooltip' data-placement='top' data-original-title=" + a_Reject + " title=" + a_Reject + "><i class='fa-regular fa-thumbs-down'></i></a></div></td>";
                    contents += '</tr>';
