<%@ Page Title="Manage Service Type" Language="C#" MasterPageFile="bu.Master" AutoEventWireup="true" CodeBehind="manageservicetype.aspx.cs" Inherits="Breederapp.manageservicetype" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="form_horizontal">
        <h5 class="float-start">
            <asp:Label ID="Label5" Text="Manage Service Type" runat="server" CssClass="error_class"></asp:Label></h5>
        ...
        <div class="row">
            <div class="col-lg-5 col-md-5 col-sm-6 col-xs-12">
                ...
                <div class="row form_row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <asp:Label ID="Label4" runat="server" CssClass="form_label"><span>Type Name</span>&nbsp;*</asp:Label>
            ...
            <div class="col-lg-7 col-md-7 col-sm-6 col-xs-12">
                ...
                <table class="table datatable">
                    <thead>
                        <th width="80%">
                            <asp:Label ID="lblName" Text="Type Name" runat="server"></asp:Label></th>
                        <th width="20%">&nbsp;</th>
                    </thead>
                    <tbody>
                    </tbody>
    ...
    <script>
        ...
        function process(pageIndex) {
            ...
            getdata3("GetServiceTypeDetails", pageIndex, filter, '', GetServiceType_Success);
        }

        function GetServiceType_Success(data) {
            $('.datatable tbody').html('');
            var xmldata = data.d;
        ...
        function deleteRecord(id) {
            deleteData("DeleteServiceType", id);
        ...
        function GetTypeClassDocs(id) {
            ...
            $.ajax({
                type: "POST",
                url: "Services/getdata.asmx/GetServiceType",
