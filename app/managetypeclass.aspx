<%@ Page Title="Manage Type class" Language="C#" MasterPageFile="main.Master" AutoEventWireup="true" CodeBehind="managetypeclass.aspx.cs" Inherits="Breederapp.managetypeclass" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <div class="form_horizontal">
        <h5 class="float-start">
            <asp:Label ID="Label5" Text="<%$Resources:Resource, Managetypeclass%>" runat="server" CssClass="error_class"></asp:Label></h5>
        ...
        <div class="row">
            <div class="col-lg-5 col-md-5 col-sm-6 col-xs-12">
                ...
                <div class="row form_row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <asp:Label ID="Label4" runat="server" CssClass="form_label"><span><%= Resources.Resource.Typeclassname %></span>&nbsp;*</asp:Label>
            ...
            <div class="col-lg-7 col-md-7 col-sm-6 col-xs-12">
                ...
                <table class="table datatable">
                    <thead>
                        <th width="20%">
                            <asp:Label ID="lblName" Text="<%$Resources:Resource, Typeclassname%>" runat="server"></asp:Label></th>
                        <th width="20%">
    ...
    <script>
        ...
        function process(pageIndex) {
            ...
            getdata3("GetTypeClassDetails", pageIndex, filter, '', GetSetBreedDoc_Success);
        }
        ...
        function GetTypeClassDocs(id) {
            ...
            $.ajax({
                type: "POST",
                url: "Services/getdata.asmx/GetTypeClass",
