<%@ Page Title="Customer Edit" Language="C#" MasterPageFile="bu.Master" AutoEventWireup="true" CodeBehind="customeredit.aspx.cs" Inherits="Breederapp.customeredit" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="form_horizontal">
        <h5>
            <asp:Label ID="lblCustomerEdit" Text="Customer Edit" runat="server" CssClass="error_class"></asp:Label></h5>
        <br />
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-8 col-xs-12">
                ...
                <div class="row form_row">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                        ...
                        <asp:DropDownList ID="ddlMembershipType" runat="server" CssClass="form_input">
                            <asp:ListItem Text="<%$Resources:Resource, Select %>" Value=""></asp:ListItem>
