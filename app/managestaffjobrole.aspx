<%@ Page Title="Manage Staff Job Role" Language="C#" MasterPageFile="bu.Master" AutoEventWireup="true" CodeBehind="managestaffjobrole.aspx.cs" Inherits="Breederapp.managestaffjobrole" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="form_horizontal">
        <h5 class="float-start">
            <asp:Label ID="Label5" Text="<%$Resources:Resource, ManageStaffJobrole%>" runat="server" CssClass="error_class"></asp:Label></h5>
    ...
    <script>
        ...
        function process(pageIndex) {
            ...
            getdata3("GetStaffJobRoles", pageIndex, filter, '', GetStaffJobRoles_Success);
        }

        function GetStaffJobRoles_Success(data) {
            $('.datatable tbody').html('');
            var xmldata = data.d;
        ...
        function deleteRecord(id) {
            deleteData("DeleteStaffJobRole", id);
            var u = window.location.href;
            window.location = u;
        }

        function GetStaffJobRole(id) {
            $("#ContentPlaceHolder1_hdfilter").val('');
            $("#ContentPlaceHolder1_txtName").val('');

            $.ajax({
                type: "POST",
                url: "Services/getdata.asmx/GetStaffJobRole",
