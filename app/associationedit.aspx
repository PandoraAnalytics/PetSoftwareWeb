...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="form_horizontal">
        ...
        <%--<%# string.Format("memberlist.aspx?aid={0}", BABusiness.BASecurity.Encrypt(ViewState["id"].ToString(), Breederapp.PageBase.HashKey)) %>--%>
      ...
      <%--  <br />
        <h6>
            ...
            <a href='<%# string.Format("memberlist.aspx?aid={0}", BABusiness.BASecurity.Encrypt(ViewState["id"].ToString(), Breederapp.PageBase.HashKey)) %>' style="color: #777;">
                ...
                <ul class="members">
                    <asp:Repeater ID="repeaterMembers" runat="server">
                        <HeaderTemplate>
                            <li>
                                <div>
                                    <a href='<%# string.Format("assignassociate.aspx?assoid={0}", BABusiness.BASecurity.Encrypt(ViewState["id"].ToString(), Breederapp.PageBase.HashKey)) %>' style="color: #777;">
