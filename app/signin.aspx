<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="signin.aspx.cs" Inherits="Breederapp.signin" %>
            ...
            <div class="row wrapper wrapper">
                ...
                <div class="col-lg-5 col-md-5 col-sm-6 col-xs-12 offset-lg-1 offset-md-1 wrapper_form">
                    <div style="width: 300px; margin: auto;">
                        ...
                        <br />
                        <div class="form_row">
                            <asp:Label ID="lblUsername" Text="<%$Resources:Resource, EmailAddress %>" runat="server" CssClass="form_label"></asp:Label>
                            <asp:TextBox ID="txtUsername" runat="server" CssClass="form_input" data-validate="required email"></asp:TextBox>
                        </div>
                        <div class="form_row">
                            <asp:Label ID="lblPassword" Text="<%$Resources:Resource, Password %>" runat="server" CssClass="form_label"></asp:Label>
                            <asp:TextBox ID="txtPassword" runat="server" CssClass="form_input" data-validate="required" TextMode="Password"></asp:TextBox>
                        </div>
                        <div class="form_row text-end">
                            <a href="forgotpassword.aspx">
                                <asp:Label ID="Label3" Text="<%$Resources:Resource, ForgotPassword %>" runat="server"></asp:Label></a>
                        </div>
                        <div class="form_row">
                            <asp:Button ID="btnLogin" CssClass="form_button" Text="<%$Resources:Resource, Signin %>" runat="server" Width="100%" OnClick="btnSignin_Click" />
                        </div>
                        <div class="form_row">
                            <asp:Label ID="Label1" Text="<%$Resources:Resource, NotRegisteredyet %>" runat="server"></asp:Label>&nbsp;<a href="signup.aspx"><asp:Label ID="Label2" Text="<%$Resources:Resource, Createyouraccount %>" runat="server"></asp:Label></a>
                        </div>
                        <div class="form_row" style="display: flex; color: #999;">
                            <span class="hor_line1">&nbsp;</span>
                            <span style="padding: 0 10px;">
                                <asp:Label ID="Label4" Text="<%$Resources:Resource, orSigninwithOTP %>" runat="server"></asp:Label></span>
                            <span class="hor_line1">&nbsp;</span>
                        </div>

                        <div class="form_row ">
                            <asp:Button ID="btnOTPLogin" CssClass="form_button" Text="<%$Resources:Resource, ReceiveanOTP %>" runat="server" Width="100%" />
                        </div>
                    </div>
                </div>
            </div>
