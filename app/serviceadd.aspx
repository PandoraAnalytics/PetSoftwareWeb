<%@ Page Title="Service Add" Language="C#" MasterPageFile="bu.Master" AutoEventWireup="true" CodeBehind="serviceadd.aspx.cs" Inherits="Breederapp.serviceadd" %>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
                <h5 class="page_title">
                    <asp:Label ID="lblHeading" Text="Service Add" CssClass="error_class" runat="server"></asp:Label></h5>
            </div>
        </div>
        <br />
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        ...
                                        <div class="row form_row">
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                ...
                                                <asp:TextBox ID="txtServicetags" runat="server" CssClass="form_input" MaxLength="80"></asp:TextBox>
                                                <span class="rule">
                                        ...
                                        <div class="row form_row">
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                ...
                                                <input type="hidden" runat="server" id="hid_service_pic" />
                                            </div>
                                        </div>
