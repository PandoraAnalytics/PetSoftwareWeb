<%@ Page Title="Join Association" Language="C#" MasterPageFile="main.master" AutoEventWireup="true" CodeBehind="joinassociation.aspx.cs" Inherits="Breederapp.joinassociation" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="form_horizontal">
        <h5 class="float-start">
            <asp:Label ID="Label5" Text="<%$Resources:Resource, JoinAssociation %>" runat="server" CssClass="error_class"></asp:Label></h5>
            ...
            <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                ...
                <div class="row form_row">
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                        ...
                        <asp:TextBox ID="txtMemberNo" runat="server" CssClass="form_input" MaxLength="20" data-validate="required"></asp:TextBox>
                    </div>
                </div>
                <div class="row form_row">
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                ...
                <div class="row form_row">
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                        <asp:Label ID="lblBreedtype" runat="server" CssClass="form_label"><span><%= Resources.Resource.BreedType %></span>&nbsp;*</asp:Label>
