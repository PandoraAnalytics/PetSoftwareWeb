...
{
    public partial class eventviewcustomfields : PageBase
    {
        ...
        {
            DataTable dataTable = EventBA.GetAssignedOtherFields(ViewState["id"]);
        ...
        protected void btnAssignOtherInfo_Click(object sender, EventArgs e)
        {
            ...
            EventBA obj = new EventBA();

            NameValueCollection collection = new NameValueCollection();
            collection["eventid"] = ViewState["id"].ToString();
