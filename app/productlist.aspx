<%@ Page Title="Product List" Language="C#" MasterPageFile="bu.Master" AutoEventWireup="true" CodeBehind="productlist.aspx.cs" Inherits="Breederapp.productlist" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="form_horizontal">
        <h6 class="float-start">
            <asp:Label ID="Label11" Text="Product List" runat="server" CssClass="error_class"></asp:Label></h6>
        <div class="float-end">
            <asp:LinkButton ID="lnkAdd" CssClass="add_form_btn btnborder" runat="server" OnClick="lnkAdd_Click">
                <i class="fa-solid fa-user-plus"></i>&nbsp;
                    <asp:Label ID="Label2" Text="Add Product" runat="server"></asp:Label>
            </asp:LinkButton>
        </div>
                    ...
                    <div class="card">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            <span class="card-title mb-0">
                                <asp:Label ID="Label7" Text="Just finish the checklist before adding your first product. It'll only take a moment! (if it's Already done? Go ahead and add your products!)" CssClass="error_class" runat="server"></asp:Label>
                            </span>
                        </div>
                ...
                <div class="table-responsive dt_container">
                    ...
                    <table class="table datatable">
                        <thead>
                            ...
                            <th width="15%">
                                <asp:Label ID="Label4" Text="Material Type" runat="server"></asp:Label></th>
                            <th width="10%">
                                <asp:Label ID="Label5" Text="Stock" runat="server"></asp:Label></th>
                            <th width="10%">&nbsp;</th>
                        </thead>
            ...
            if (xmldata != null && xmldata.length > 2) {
                ...
                records.each(function () {
                    ...
                    if (availableqty > thvalue) {
                        contents += '<td style="color:#008000";>' + record.find("availablestock").text() + '/' + record.find("totalstock").text() + '</td>';
                    }
                    else if (availableqty == thvalue) {
                        contents += '<td style="color:#FFA500";>' + record.find("availablestock").text() + '/' + record.find("totalstock").text() + '</td>';
                    }
                    else if (availableqty < thvalue) {
                        contents += '<td style="color:#FF0000";>' + record.find("availablestock").text() + '/' + record.find("totalstock").text() + '</td>';
                    }
