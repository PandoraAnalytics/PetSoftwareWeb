...
{
    public partial class customfieldsedit : PageBase
    {
        protected void Page_Init(object sender, EventArgs e)
        {
            //string questionId = DecryptQueryString("id"); // page_init can't access viewstate, need to read query string again
        ...
        private void PopulateControls()
        {
            ...
            if (collection == null) Response.Redirect("customfields.aspx");
            ...
            if (!string.IsNullOrEmpty(associationbreedertype) && !string.IsNullOrEmpty(collection["breedtype"]))
            {
                ...
                if (intersect == null || intersect.Length == 0) Response.Redirect("customfields.aspx");
            }
