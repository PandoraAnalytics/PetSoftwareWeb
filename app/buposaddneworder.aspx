<%@ Page Title="Add POS Order" Language="C#" MasterPageFile="bu.Master" AutoEventWireup="true" CodeBehind="buposaddneworder.aspx.cs" Inherits="Breederapp.buposaddneworder" %>
        ...
        <div class="form_horizontal">
            <div class="row">
                <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
                    <h6 class="page_title">
                        <asp:Label ID="lblHeading" Text="Add POS Order" CssClass="error_class" runat="server"></asp:Label>
                    </h6>
                </div>
