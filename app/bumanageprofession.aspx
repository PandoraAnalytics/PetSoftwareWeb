<%@ Page Title="Manage Category" Language="C#" MasterPageFile="bu.Master" AutoEventWireup="true" CodeBehind="bumanageprofession.aspx.cs" Inherits="Breederapp.bumanageprofession" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="form_horizontal">
        <h5 class="float-start">
            <asp:Label ID="Label5" Text="<%$Resources:Resource, ManageCategory%>" runat="server" CssClass="error_class"></asp:Label></h5>
    ...
    <script>
        ...
        function process(pageIndex) {
            ...
            getdata3("GetProfessions", pageIndex, filter, '', GetSetProfessions_Success);
        }
        ...
        function deleteRecord(id) {
            deleteData("DeleteProfession", id);
        ...
        function GetProfession(id) {
            ...
            $.ajax({
                type: "POST",
                url: "Services/getdata.asmx/GetProfession",
