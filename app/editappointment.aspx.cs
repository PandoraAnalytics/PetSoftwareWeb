...
{
    public partial class editappointment : PageBase
    {
        ...
        {
            NameValueCollection collection = AnimalBA.GetAnimalAppointmentDetaillByDate(ViewState["id"], this.UserId);
        ...
        private void Update(bool xiThisOccuranceAndFollowing)
        {
            ...
            if (sucess)
            {
                Response.Redirect("appointmentlist.aspx?id=" + ViewState["animalid"]);
            }
            else
            {
