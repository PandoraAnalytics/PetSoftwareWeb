<%@ Page Title="Manage Product Brand" Language="C#" MasterPageFile="bu.Master" AutoEventWireup="true" CodeBehind="manageproductbrandtype.aspx.cs" Inherits="Breederapp.manageproductbrandtype" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
      <div class="form_horizontal">
        <h5 class="float-start">
            <asp:Label ID="Label5" Text="Manage Product Brand" runat="server" CssClass="error_class"></asp:Label></h5>
        ...
        <div class="row">
            <div class="col-lg-5 col-md-5 col-sm-6 col-xs-12">
                ...
                <div class="row form_row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <asp:Label ID="Label4" runat="server" CssClass="form_label"><span>Brand Name</span>&nbsp;*</asp:Label>
            ...
            <div class="col-lg-7 col-md-7 col-sm-6 col-xs-12">
                ...
                <table class="table datatable">
                    <thead>
                        <th width="20%">
                            <asp:Label ID="lblName" Text="Brand Name" runat="server"></asp:Label></th>
                        <th width="10%">&nbsp;</th>
                    </thead>
                    <tbody>
                    </tbody>
    ...
    <script>
        ...
        function process(pageIndex) {
            ...
            getdata3("GetProductBrandDetails", pageIndex, filter, '', GetProductBrand_Success);
        }

        function GetProductBrand_Success(data) {
            $('.datatable tbody').html('');
            var xmldata = data.d;
        ...
        function deleteRecord(id) {
            deleteData("DeleteProductBrand", id);
        ...
        function GetTypeClassDocs(id) {
            ...
            $.ajax({
                type: "POST",
                url: "Services/getdata.asmx/GetProductBrand",
