<%@ Page Title="" Language="C#" MasterPageFile="breeder.master" AutoEventWireup="true" CodeBehind="foodlist.aspx.cs" Inherits="Breederapp.foodlist" %>
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <ul class="dt_filters pull-left">
                        ...
                        <li>
                            <label><asp:Label ID="Label5" Text="<%$Resources:Resource, Site %>" runat="server"></asp:Label></label><br />
            ...
            if (xmldata != null && xmldata.length > 2) {
                ...
                records.each(function () {
                   ...
                   var foodtype = "";
                    ...
                    contents += "<td><div class='btn-group btn-group-sm dt_action_btns'><a href='addfood.aspx?id=" + id + "' class='btn btn_edit' data-toggle='tooltip' data-placement='top' data-original-title='Edit' title='Edit'><i class='fa fa-pencil'></i></a><a href='javascript:void(0);' onclick='deleteRecord(\"" + id + "\")' class='btn btn_delete' data-toggle='tooltip' data-placement='top' data-original-title='Delete' title='Delete'><i class='fa fa-trash'></i></a></div></td>";
                    contents += '</tr>';
