<%@ Page Title="Order Details Report" Language="C#" MasterPageFile="bu.Master" AutoEventWireup="true" CodeBehind="custreportorderdetails.aspx.cs" Inherits="Breederapp.custreportorderdetails" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script>        
        ...
        function loadOrderReport() {
            var totalcount = gettotalcount("GetCustReportCount", filter);
            process(1);
        ...
        function process(pageIndex) {
            ...
            getdata3("GetCustReportList", pageIndex, filter, '', getCustReportList_Success);
        }

        function getCustReportList_Success(data) {
            $('#ordertable tbody').html('');
            var xmldata = data.d;
