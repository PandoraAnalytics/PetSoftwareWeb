<%@ Page Title="Manage Tax" Language="C#" MasterPageFile="bu.Master" AutoEventWireup="true" CodeBehind="bumanagetax.aspx.cs" Inherits="Breederapp.bumanagetax" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server"> <div class="form_horizontal">
        <h5 class="float-start">
            <asp:Label ID="Label5" Text="Manage Tax" runat="server" CssClass="error_class"></asp:Label></h5>
        ...
        <div class="row">
            <div class="col-lg-5 col-md-5 col-sm-6 col-xs-12">
                ...
                <div class="row form_row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <asp:Label ID="Label1" runat="server" CssClass="form_label"><span>Percentage</span>&nbsp;*</asp:Label>
                        <asp:DropDownList ID="ddlPercentage" runat="server" CssClass="form_input" data-validate="required">
                        </asp:DropDownList>
                    </div>
                </div>
                <div class="row form_row">
            ...
            <div class="col-lg-7 col-md-7 col-sm-6 col-xs-12">
                ...
                <table class="table datatable">
                    <thead>
                        ...
                        <th width="20%">
                            <asp:Label ID="Label2" Text="Percentage" runat="server"></asp:Label></th>
                        <th width="10%">&nbsp;</th>
                    </thead>
    ...
    <script>
       ...
       $(document).ready(function () {
        ...
        function process(pageIndex) {
            ...
            getdata3("GetAllBUTax", pageIndex, filter, '', GetAllBUTax_Success);
        }

        function GetAllBUTax_Success(data) {
            $('.datatable tbody').html('');
            var xmldata = data.d;
        ...
        function deleteRecord(id) {
            deleteData("DeleteBUTax", id);
            var u = window.location.href;
            window.location = u;
        }

        function GetBUTax(id) {
            $("#ContentPlaceHolder1_hdfilter").val('');
            $("#ContentPlaceHolder1_txtName").val('');
            $("#ContentPlaceHolder1_ddlPercentage").val('');

            $.ajax({
                type: "POST",
                url: "Services/getdata.asmx/GetBUTax",
                ...
                success: function (msg) {
                    if (msg != null && msg.d != null) {
                        ...
                        $("#ContentPlaceHolder1_ddlPercentage").val(ppe.percentage);
