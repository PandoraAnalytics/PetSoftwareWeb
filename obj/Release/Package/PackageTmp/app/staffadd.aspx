<%@ Page Title="Staff Add" Language="C#" MasterPageFile="bu.Master" AutoEventWireup="true" CodeBehind="staffadd.aspx.cs" Inherits="Breederapp.staffadd" %>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
                <h5 class="page_title">
                    <asp:Label ID="lblHeading" Text="<%$Resources:Resource, StaffAdd %>" CssClass="error_class" runat="server"></asp:Label></h5>
            </div>
        </div>
        <br />
                            ...
                            <div class="form_horizontal basic_deatils_form" style="line-height: 25px;">
                                <div class="row">
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        ...
                                        <div class="row form_row">
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                <asp:Label ID="Label8" Text="<%$Resources:Resource, JoiningDate %>" runat="server" CssClass="form_label"></asp:Label>
