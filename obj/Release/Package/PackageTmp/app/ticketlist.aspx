<%@ Page Title="Ticket List" Language="C#" MasterPageFile="user.Master" AutoEventWireup="true" CodeBehind="ticketlist.aspx.cs" Inherits="Breederapp.ticketlist" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <link href="css/datepicker3.css" rel="stylesheet" />
    <link rel="stylesheet" type="text/css" href="css/multi-select-chk.css" />
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="form_horizontal">
        <h5>
            <asp:Label ID="Label11" Text="<%$Resources:Resource, Ticketlist %>" runat="server" CssClass="error_class"></asp:Label></h5>
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="filter_section">
                    <i class="fa-solid fa-filter"></i>&nbsp;
                        ...
                        <select id="ddlStatus" multiple runat="server" datatextfield="name" datavaluefield="id"></select>&nbsp;                      
                    <br />
                    <br />
        ...
        <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                <h6>
                    <asp:Label ID="lblEDTSum" runat="server" CssClass="error_class "></asp:Label></h6>
            </div>
    ...
    <script>
        ...
        $(document).ready(function () {
            $("#ContentPlaceHolder1_ddlStatus").multiSelect();
            filter = $('#ContentPlaceHolder1_hidfilter').val();
            var totalcount = gettotalcount("GetTicketsCount", filter);
            process(1);
        ...
        function process(pageIndex) {
            ...
            window.scrollTo(0, 0);
            var xmldata = getdata("GetTickets", pageIndex, filter);
