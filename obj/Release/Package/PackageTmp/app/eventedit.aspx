<%@ Page Title="Event Edit" Language="C#" MasterPageFile="main.Master" AutoEventWireup="true" CodeBehind="eventedit.aspx.cs" Inherits="Breederapp.eventlist" %>
    ...
    <div class="form_horizontal">
        ...
        <div class="row">
            <div class="col-lg-8 col-md-8 col-sm-6 col-xs-12">
                ...
                <div class="row form_row">
                    <div class="col-lg-12 col-md-12 col-sm-12  col-xs-12">
                        <asp:Label ID="Label11" Text="<%$Resources:Resource, Visible %>" runat="server" CssClass="form_label"></asp:Label>
                        <%-- <asp:DropDownList ID="ddlVisible" multiple runat="server" class="form_input multipleSelect" data-validate="required">--%>
                        <select id="ddlVisible" multiple runat="server" class="form_input multipleSelect" data-validate="required">
                        ...
                        <%--<asp:ListItem Text="<%$Resources:Resource, Visibletome %>" Value="1"></asp:ListItem>
                            <asp:ListItem Text="<%$Resources:Resource, VisibletoALL %>" Value=""></asp:ListItem>
                            <asp:ListItem Text="<%$Resources:Resource, VisibleToMyAssociation %>" Value="3"></asp:ListItem>--%>
                        <%--</asp:DropDownList>--%>
                    </div>
                </div>
                <div class="row form_row">
                ...
                <div class="row form_row">
                    <div class="col-lg-12 col-md-12 col-sm-12  col-xs-12">
                        <asp:Label ID="Label1" runat="server"
                            CssClass="form_label"><span><%= Resources.Resource.SelectAnimal %></span>&nbsp;*</asp:Label>
                ...
                <div class="row form_row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <asp:Button ID="btnCreateEvent" CssClass="form_button" Text="<%$Resources:Resource, UpdateEvent %>" runat="server" OnClick="btnUpdateEvent_Click" />&nbsp;
                    </div>
                </div>
            </div>
