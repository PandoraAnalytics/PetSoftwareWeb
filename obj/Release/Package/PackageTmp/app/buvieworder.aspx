<%@ Page Title="Order View" Language="C#" MasterPageFile="bu.Master" AutoEventWireup="true" CodeBehind="buvieworder.aspx.cs" Inherits="Breederapp.buvieworder" %>
        ...
        <div class="form_horizontal">
            <div class="row">
                <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
                    <h6 class="page_title">
                        <asp:Label ID="lblHeading" Text="Order View" CssClass="error_class" runat="server"></asp:Label></h6>
                </div>
