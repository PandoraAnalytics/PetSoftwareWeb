<%@ Page Title="Application List" Language="C#" MasterPageFile="user.Master" AutoEventWireup="true" CodeBehind="ticketapplicationlist.aspx.cs" Inherits="Breederapp.ticketapplicationlist" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="form_horizontal">
        <h5>
            <asp:Label ID="Label11" Text="<%$Resources:Resource, ApplicationList %>" runat="server" CssClass="error_class"></asp:Label></h5>
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-end">
                <div class="float-end">
                    <a href="ticketapplicationmanage.aspx" class="add_form_btn btnborder">+&nbsp;<asp:Label ID="Label2" runat="server" Text="<%$Resources:Resource, AddNew %>"></asp:Label>
                    </a>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <table class="table datatable">
                    <thead>
                        <th width="70%">
                            <asp:Label ID="Label5" Text="<%$Resources:Resource, Application %>" runat="server"></asp:Label></th>
                        <th width="10%">&nbsp;</th>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            var totalcount = gettotalcount("GetTicketApplicationCount", filter);
            process(1);
            $('.pagination').bootpag({
                total: totalcount,
                page: 1,
        ...
        function process(pageIndex) {
            ...
            getdata3("GetTicketApplicationDetails", pageIndex, filter, '', getDetails_Success);
        }
        ...
        function getDetails_Success(data) {
            ...
            if (xmldata != null && xmldata.length > 2) {
                ...
                records.each(function () {
                    ...
                    contents += "<td><div class='btn-group btn-group-sm dt_action_btns'><a href='ticketapplicationmanage.aspx?" + id + "' class='btn btn_edit' data-toggle='tooltip' data-placement='top' data-original-title='Edit' title='Edit'><i class='fa fa-pencil'></i></a><a href='javascript:void(0);' onclick='deleteRecord(\"" + id + "\")' class='btn btn_delete' data-toggle='tooltip' data-placement='top' data-original-title='Delete' title='Delete'><i class='fa-regular fa-trash-can'></i></a></div></td>";
                    contents += '</tr>';
        ...
        function deleteRecord(id) {
            deleteData("DeleteTicketApplication", id);
            process(1);
        }
    </script>
</asp:Content>
