<%@ Page Title="Breed - Contact List" Language="C#" MasterPageFile="main.master" AutoEventWireup="true" CodeBehind="contactlist.aspx.cs" Inherits="Breederapp.contactlist" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="form_horizontal">
        <h5>
            <asp:Label ID="Label11" Text="<%$Resources:Resource, ContactList %>" runat="server" CssClass="error_class"></asp:Label></h5>
        <div class="row">
        ...
        function getContactDetails_Success(data) {
            ...
            if (xmldata != null && xmldata.length > 2) {
                ...
                records.each(function () {
                    ...
                    contents += "<td><div class='btn-group btn-group-sm dt_action_btns'><a href='createcontact.aspx?id=" + id + "' class='btn btn_edit' data-toggle='tooltip' data-placement='top' data-original-title='Edit' title='Edit'><i class='fa fa-pencil'></i></a><a href='javascript:void(0);' onclick='deleteRecord(\"" + id + "\")' class='btn btn_delete' data-toggle='tooltip' data-placement='top' data-original-title='Delete' title='Delete'><i class='fa fa-trash'></i></a></div></td>";
                    contents += '</tr>';
