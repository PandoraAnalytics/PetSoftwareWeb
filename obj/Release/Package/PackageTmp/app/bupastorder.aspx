<%@ Page Title="Past Orders" Language="C#" MasterPageFile="bu.Master" AutoEventWireup="true" CodeBehind="bupastorder.aspx.cs" Inherits="Breederapp.bupastorder" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="form_horizontal">
        <h6>
            <asp:Label ID="Label11" Text="Past Orders" runat="server" CssClass="error_class"></asp:Label></h6>
