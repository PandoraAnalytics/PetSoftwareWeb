<%@ Page Title="Other Fields" Language="C#" MasterPageFile="main.Master" AutoEventWireup="true" CodeBehind="customfields.aspx.cs" Inherits="Breederapp.customfields" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="form_horizontal">
        ...
        <div class="float-end">
            <a href="customfieldsadd.aspx" class="add_form_btn btnborder">+&nbsp;<asp:Label ID="Label2" runat="server" Text="<%$Resources:Resource, AddNew %>"></asp:Label>
            </a>
        </div>
            ...
            if (xmldata != null && xmldata.length > 2) {
                ...
                records.each(function () {
                    ...
                    if (record.find("active").text() == "2") {
                        ...
                        contents += "<td><div class='btn-group btn-group-sm dt_action_btns'><a href='customfieldsedit.aspx?" + id + "' class='btn btn_edit' data-toggle='tooltip' data-placement='top' data-original-title='Edit' title='Edit'><i class='fa fa-pencil'></i></a><a href='javascript:void(0);' onclick='deleteRecord(\"" + id + "\")' class='btn btn_delete' data-toggle='tooltip' data-placement='top' data-original-title='Delete' title='Delete'><i class='fa-regular fa-trash-can'></i></a></div></td>";
