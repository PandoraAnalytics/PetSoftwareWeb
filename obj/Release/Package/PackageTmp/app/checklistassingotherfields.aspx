<%@ Page Title="Assign Other Fields" Language="C#" MasterPageFile="user.Master" AutoEventWireup="true" CodeBehind="checklistassingotherfields.aspx.cs" Inherits="Breederapp.checklistassingotherfields" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="form_horizontal">
        <h5 class="float-start">
            <asp:Label ID="Label5" Text="<%$Resources:Resource, Assignotherfields %>" runat="server" CssClass="error_class"></asp:Label></h5>
        <div class="float-end">
            <a href="checklist.aspx" class="edit_profile_link">
            ...
            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                ...
                <div class="row form_row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <asp:Button ID="btnAssignOtherInfo" runat="server" Text="<%$Resources:Resource, Assigntochecklist %>" CssClass="form_button top_btn" OnClick="btnAssignOtherInfo_Click" validate="no" />
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                ...
                <div class="main_container">
                    <div class="row form_row">
                        <asp:Panel ID="panelNoQuestion" runat="server">
                            <asp:Label ID="lbldropithere" Text="<%$Resources:Resource, Selectotherfieldsfromlefthandsidetoassignwiththischecklist %>" runat="server"></asp:Label>
                        </asp:Panel>
            ...
            <div class="col-lg-3 col-md-3 col-sm-5 col-xs-12">
                ...
                <asp:Panel ID="panelOtherInfo" runat="server">
                    ...
                    <asp:Panel ID="panelMatrix" runat="server" Visible="false">
                        <div class="row form_row">
                            <div class=" form_label col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <asp:Label ID="Label2" runat="server" CssClass="form_label"><span><%= Resources.Resource.NumberofRows %></span>&nbsp;* 
                                </asp:Label>
                        ...
                        <div class="row form_row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <asp:Label ID="Label7" runat="server" CssClass="form_label"><span><%= Resources.Resource.ColumnName %></span>&nbsp;* 
                                </asp:Label>
