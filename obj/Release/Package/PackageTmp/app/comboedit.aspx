<%@ Page Title="Combo Edit" Language="C#" MasterPageFile="bu.Master" AutoEventWireup="true" CodeBehind="comboedit.aspx.cs" Inherits="Breederapp.comboedit" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="form_horizontal">
        <h5>
            <asp:Label ID="lblComboEdit" Text="Combo Edit" runat="server" CssClass="error_class"></asp:Label></h5>
        <br />
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-8 col-xs-12">
                ...
                <div class="row form_row">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                        ...
                        <input type="hidden" runat="server" id="hid_combo_pic" />&nbsp;&nbsp;<a href="javascript:void(0);" id="lnkComboProfilePic" runat="server" target="_blank">View Profile Pic</a>
                    </div>
                </div>
                <br />
                <div class="row">
        ...
        function getProductDetails_Success(data) {
            ...
            if (xmldata != null && xmldata.length > 2) {
                ...
                records.each(function () {
                    ...
                    if (inArray >= 0) {
                        contents += '<td width="5%" valign="top"><input type="checkbox" class="call-checkbox" value="' + id1 + '" checked></td>';
                    } else {
                        contents += '<td width="5%" valign="top"><input type="checkbox" class="call-checkbox" value="' + id1 + '"></td>';
                    }
        ...
        function getServicesDetails_Success(data) {
            ...
            if (xmldata != null && xmldata.length > 2) {
                ...
                records.each(function () {
                    ...
                    if (inArray2 >= 0) {
                        contents += '<td width="5%" valign="top"><input type="checkbox" class="call-checkbox" value="' + id2 + '" checked></td>';
                    } else {
                        contents += '<td width="5%" valign="top"><input type="checkbox" class="call-checkbox" value="' + id2 + '"></td>';
                    }
                    var main_desc = record.find("description").text();
                    if (main_desc.length > 50) main_desc = '<span data-toggle="tooltip" data-placement="top" data-original-title="' + record.find("description").text().replace(/"/g, "&quot;") + '">' + main_desc.substring(0, 50) + '...' + '</span>';
                    contents += '<td width="80%">' + record.find("name").text() + '<div style="margin-top:5px;opacity:0.8">' + main_desc + '</div></td>';
