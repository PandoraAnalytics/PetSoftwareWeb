<%@ Page Title="Manage Staff Department" Language="C#" MasterPageFile="bu.Master" AutoEventWireup="true" CodeBehind="managestaffdepartment.aspx.cs" Inherits="Breederapp.managestaffdepartment" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="form_horizontal">
        <h5 class="float-start">
            <asp:Label ID="Label5" Text="<%$Resources:Resource, ManageStaffDepartment%>" runat="server" CssClass="error_class"></asp:Label></h5>
    ...
    <script>
        ...
        function process(pageIndex) {
            ...
            getdata3("GetStaffDepartments", pageIndex, filter, '', GetStaffDepartments_Success);
        }

        function GetStaffDepartments_Success(data) {
            $('.datatable tbody').html('');
            var xmldata = data.d;
        ...
        function deleteRecord(id) {
            deleteData("DeleteStaffDepartment", id);
            var u = window.location.href;
            window.location = u;
        }

        function GetStaffDepartment(id) {
            $("#ContentPlaceHolder1_hdfilter").val('');
            $("#ContentPlaceHolder1_txtName").val('');

            $.ajax({
                type: "POST",
                url: "Services/getdata.asmx/GetStaffDepartment",
