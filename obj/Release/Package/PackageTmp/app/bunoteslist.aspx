<%@ Page Title="Breed - Notes List" Language="C#" MasterPageFile="bubreeder.master" AutoEventWireup="true" CodeBehind="bunoteslist.aspx.cs" Inherits="Breederapp.bunoteslist" %>
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <ul class="dt_filters pull-left">
                        ...
                        <li>
                            <asp:Label ID="Label4" Text="<%$Resources:Resource, Site %>" runat="server"></asp:Label>
        ...
        function getAnimalNotesDetails_Success(data) {
            ...
            if (xmldata != null && xmldata.length > 2) {
                ...
                records.each(function () {
                    ...
                    contents += "<td><div class='btn-group btn-group-sm dt_action_btns'><a href='bunotesdetails.aspx?id=" + id + "' class='btn btn_edit' data-toggle='tooltip' data-placement='top' data-original-title='Edit' title='Edit'><i class='fa fa-pencil'></i></a><a href='javascript:void(0);' onclick='deleteRecord(\"" + id + "\")' class='btn btn_delete' data-toggle='tooltip' data-placement='top' data-original-title='Delete' title='Delete'><i class='fa fa-trash'></i></a></div></td>";
                    contents += '</tr>';
