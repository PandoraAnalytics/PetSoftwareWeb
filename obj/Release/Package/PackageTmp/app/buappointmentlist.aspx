<%@ Page Title="Appointment List" Language="C#" MasterPageFile="bubreeder.master" AutoEventWireup="true" CodeBehind="buappointmentlist.aspx.cs" Inherits="Breederapp.buappointmentlist" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            var totalcount = gettotalcount("GetCustomerAnimalAppointmentCount", JSON.stringify(filterjson));
            process(1);
            $('.pagination').bootpag({
                total: totalcount,
                page: 1,
        ...
        function process(pageIndex) {
            ...
            getdata3("GetCustomerAnimalAppointmentDetails", pageIndex, JSON.stringify(filterjson), '', getAppointment_Success);
        }
        ...
        function getAppointment_Success(data) {
            ...
            if (xmldata != null && xmldata.length > 2) {
                ...
                records.each(function () {
                    ...
                    var userid = record.find("secureduserid").text();
                    ...
                    var actioncontents = "<a href='buappointmentview.aspx?id=" + id + "&uid=" + userid + "' target='_blank' class='btn btn_edit' data-toggle='tooltip' data-placement='top' data-original-title='View' title='View'><i class='fa fa-eye'></i></a>";
                    if (parseInt(record.find("ispastappointment").text()) == 0) {
                        actioncontents += "<a href='bueditappointment.aspx?id=" + id + "&uid=" + userid + "' class='btn btn_edit' data-toggle='tooltip' data-placement='top' data-original-title='Edit' tilte='Edit'><i class='fa fa-pencil'></i></a>";
                    }
