<%@ Page Title="Breed - Basic Details" Language="C#" MasterPageFile="breeder.master" AutoEventWireup="true" CodeBehind="basicdetails.aspx.cs" Inherits="Breederapp.basicdetails" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="form_horizontal">
        <h5 class="float-start">
            <asp:Label ID="Label11" Text="<%$Resources:Resource, BasicInfo %>" runat="server" CssClass="error_class"></asp:Label></h5>
        <div class="float-end ">
