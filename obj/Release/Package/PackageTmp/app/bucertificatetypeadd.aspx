<%@ Page Title="Certificate Type Add" Language="C#" MasterPageFile="bu.Master" AutoEventWireup="true" CodeBehind="bucertificatetypeadd.aspx.cs" Inherits="Breederapp.bucertificatetypeadd" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="form_horizontal">
        <h5 class="float-start">
            <asp:Label ID="Label2" Text="<%$Resources:Resource, CertificateTypeAdd %>" runat="server" CssClass="error_class"></asp:Label></h5>
